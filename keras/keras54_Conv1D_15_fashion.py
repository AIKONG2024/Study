...
from keras.layers import Dense, Conv2D, Dropout, MaxPooling2D, Flatten, LSTM, Conv1D
import numpy as np
...
#2.모델구성
model = Sequential()
model.add(Conv1D(64, 2, input_shape = (x_train.shape[0] * x_train.shape[1],), activation='relu'))
model.add(Flatten())
