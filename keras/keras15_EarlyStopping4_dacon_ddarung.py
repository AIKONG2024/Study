...
hist = model.fit(x_train, y_train, epochs=30000, batch_size=100, validation_split=0.3, callbacks=[es]) #98
...
#3. 컴파일, 훈련
model.compile(loss='mse', optimizer='adam')
hist = model.fit(x_train, y_train, epochs=3000, batch_size=70, validation_split=0.3, callbacks=[es]) #98
