...
model = Sequential()
model.add(Conv1D(128,2, input_shape = (x_train.shape[1] * x_train.shape[2],), activation='relu'))
model.add(Flatten())
...
RNN 결과 ======================================
loss : 2.296576738357544
acc : 0.17180000245571136
acc_score : 0.1718
time : 209.43 초
========================
Conv1D
acc_score :  0.1909
elapsed time :  501.16 sec
'''