...
#2. 모델
model = Sequential()
model.add(Conv1D(16, 2, input_shape = (28*28, 1)))
model.add(Flatten())
...
model.fit(x_train, y_train, batch_size=100, verbose= 1, epochs= 1000, validation_split=0.2, callbacks=[es] )
...
=============================
RNN 결과
loss =  0.6843985915184021
acc =  0.7462999820709229
313/313 [==============================] - 3s 10ms/step
[7 2 1 ... 9 8 6]

=============================
Conv1D
loss =  0.13346105813980103
