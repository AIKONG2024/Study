...
model.add(Conv2D(10, (3,3))) #(28,28,9)
model.add(Reshape(target_shape=(26*26, 10))) #26*26, 10
model.add(Conv1D(15,4)) #(676,10)
model.add(LSTM(8, return_sequences=True)) #(673, 15)
model.add(Conv1D(14,2)) #(673, 8)
model.add(Flatten()) #(672, 14)
model.add(Dense(32, activation='relu'))#(9408)
model.add(Dense(16, activation='relu')) #(32)
model.add(Dense(32, activation='relu')) #(16)
model.add(Dense(32, activation='relu')) #(32)
model.add(Flatten()) #(32)
model.add(Dense(32, activation='relu')) #(32)
model.add(Dense(10, activation='softmax')) #(32)
#(10)
