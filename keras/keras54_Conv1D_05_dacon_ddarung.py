...
#2. 모델
model = Sequential()
model.add(Conv1D(16, 2,input_shape= (9,1)))
model.add(Flatten())
model.add(Dense(512))
...
CNN===================
loss :  [2004.8984375, 2004.8984375, 31.157752990722656, 0.004566209856420755]
r2 :  0.7121890107300424
====================
RNN 적용후
loss :  [2202.62353515625, 2202.62353515625, 32.79004669189453, 0.004566209856420755]
r2 :  0.6838047974486356
============================
Conv1D 적용후
loss :  [1865.81396484375, 1865.81396484375, 29.47007179260254, 0.004566209856420755]
r2 :  0.7321551424114325
'''