...
model = Sequential()
model.add(Conv1D(16, 2, input_shape = (30,1)))
model.add(Flatten())
model.add(Dense(64)) #기본 함수는 linear
...
CNN
accuracy : 0.935672514619883
[0.1826445609331131, 0.9356725215911865]

===========================
RNN 적용후
accuracy : 0.9181286549707602
[0.22076097130775452, 0.9181286692619324]
===========================
Conv1D 적용후:
accuracy : 0.9532163742690059
[0.27961787581443787, 0.9532163739204407]
'''