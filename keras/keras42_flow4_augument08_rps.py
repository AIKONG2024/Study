...
image_path = 'C:\_data\image/rps/test/'
path = 'C:\_data/kaggle/rps/'
np_path = 'C:\_data\_save_npy/rps/'

train_x_npy_exists = os.path.exists(np_path + "keras_rps_x_train.npy") 
train_y_npy_exists = os.path.exists(np_path + "keras_rps_y_train.npy") 
...
if not train_x_npy_exists and not train_y_npy_exists :#train npy 존재
    ...
    np.save(np_path + 'keras_rps_x_train.npy', arr=x_train)
    np.save(np_path + 'keras_rps_y_train.npy', arr=y_train)
    
else: 
    x_train = np.load(np_path + 'keras_rps_x_train.npy')
    y_train = np.load(np_path + 'keras_rps_y_train.npy')
