...
model = Sequential()
model.add(Conv1D(32, kernel_size=2 ,input_shape = (8,1)))
model.add(Flatten())
model.add(Dense(10))
model.add(Dense(30))
...
hist = model.fit(x_train, y_train, epochs=100, verbose=1, validation_split= 0.7, callbacks=[])
...
loss : 1.2975385189056396
 ...
 ===========================
CNN  적용: 
loss : 0.5507452487945557
============================
RNN 적용후
loss : 0.35610589385032654
============================
Conv1D 적용후
loss : 0.6528691053390503
'''
