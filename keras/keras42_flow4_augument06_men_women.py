...
path = 'C:\_data\image\man_women/'
path_train ='C:\_data/image/man_women/train/'
path_test ='C:\_data/image/man_women/test/'
image_path = 'C:\_data/image/man_women/test/'
path = 'C:\_data/kaggle/man_women/'
np_path = '../_data/_save_npy/'

train_x_npy_exists = os.path.exists(np_path + "keras_man_women_x_train.npy") 
train_y_npy_exists = os.path.exists(np_path + "keras_man_women_y_train.npy") 
test_npy_exists = os.path.exists(np_path + "keras_man_women_x_test.npy")
...
if not train_x_npy_exists and not train_y_npy_exists :#train npy 존재
    ...
    np.save(np_path + 'keras_man_women_x_train.npy', arr=x_train)
    np.save(np_path + 'keras_man_women_y_train.npy', arr=y_train)
    
else: 
    x_train = np.load(np_path + 'keras_man_women_x_train.npy')
    y_train = np.load(np_path + 'keras_man_women_y_train.npy')
...
if not test_npy_exists :#test npy 존재
    ...
    x_test = xy_test[0][0]
    np.save(np_path + 'keras_man_women_x_test.npy', arr=x_test)
else:
    x_test = np.load(np_path + 'keras_man_women_x_test.npy')
