...
from tensorflow.keras.models import Sequential #순차적 모델을 땡겨옴
from tensorflow.keras.layers import Dense #Dense(아직 설명x)를 땡겨옴
import numpy as np
...
model.fit(x,y, epochs = 1000) #fit() 훈련시키기. epochs: 훈련을 너무 많이 시키면 과적합 됨.-> 터짐. 훈련양을 조절해야함. 10번으로 조절, 이 과정으로 최적의 웨이트가 생성
