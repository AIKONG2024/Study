...
model.fit(X_train, y_train, eval_set = [(X_test, y_test),(X_train, y_train)], eval_metric = ["mae"]) #rmse> mae> logloss > error
...
best_loss = mean_absolute_error(y_test, x_predictsion)
print(
f"""
============================================
[Best r2_score: {best_score}]
[Best mae_score: {best_loss}]
============================================
"""
)
...
for idx in range(len(hist)):
    plt.plot(hist[f'validation_{idx}']['mae'])
