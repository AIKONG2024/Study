...
parameters = [
    {"randomForestClassifier__n_jobs" : [-1], "randomForestClassifier__n_estimators": [100, 200],  "randomForestClassifier__min_samples_leaf": [3, 10]},
    {"randomForestClassifier__n_jobs" : [-1], "randomForestClassifier__min_samples_leaf": [3, 5, 7, 10]},
    {"randomForestClassifier__n_jobs" : [-1], "randomForestClassifier__min_samples_leaf": [3, 5, 7, 10], "randomForestClassifier__min_samples_split": [2, 3, 5, 10]},
